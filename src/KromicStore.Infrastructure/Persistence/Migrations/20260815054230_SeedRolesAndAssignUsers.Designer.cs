...
namespace KromicStore.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260815054230_SeedRolesAndAssignUsers")]
    partial class SeedRolesAndAssignUsers
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KromicStore.Domain.CMS.Entities.CMSPage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<DateTime?>("ScheduledPublishDateUtc")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("KromicStore.Domain.Email.Entities.EmailOutbox", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Media.Entities.ProductImageArchive", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.AuditLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("IsSearchIndexed")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.ContactRequest", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ContactRequestSet");
                });

            modelBuilder.Entity("KromicStore.Domain.Tenants.ContactRequestReply", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("WasEmailSentToRequester")
                        .HasColumnType("boolean");
                    ...
                    b.ToTable("ContactRequestReply");
                });

            modelBuilder.Entity("KromicStore.Domain.Tenants.FeatureFlag", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FeatureFlagSet");
                });

            modelBuilder.Entity("KromicStore.Domain.Tenants.FeatureFlagAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("FeatureFlagAssignment");
                });

            modelBuilder.Entity("KromicStore.Domain.Tenants.PlatformSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("AllowTrialSignups")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("EnableErrorTracking")
                        .HasColumnType("boolean");
                    ...
                    b.Property<string>("MaintenanceNoticeEmailTemplate")
                        .HasColumnType("text");

                    b.Property<int>("MaxFreeTrialDays")
                        .HasColumnType("integer");

                    b.Property<int>("MaxTenantsPerPlatform")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("ResetPasswordEmailTemplate")
                        .HasColumnType("text");
                    ...
                    b.ToTable("PlatformSettingsSet");
                });

            modelBuilder.Entity("KromicStore.Domain.Tenants.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("CanCustomizeDomain")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseAdvancedInventory")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseAdvancedReporting")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseAnalytics")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseCustomTheme")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseEmailMarketing")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseMultipleCurrencies")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUsePaymentGateway")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUsePrioritySupportEmail")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUsePrioritySupportPhone")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseSeo")
                        .HasColumnType("boolean");

                    b.Property<bool>("CanUseThemes")
                        .HasColumnType("boolean");
                    ...
                    b.Property<decimal?>("TrialPricePerDay")
                        .HasColumnType("numeric");

                    b.HasKey("Id");

                    b.ToTable("SubscriptionPlanSet");
                });
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.Theme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.ThemeAsset", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("ThemeAssets", (string)null);
                });

            modelBuilder.Entity("KromicStore.Domain.Tenants.ThemeVersion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.ContactRequestReply", b =>
                {
                    b.HasOne("KromicStore.Domain.Tenants.ContactRequest", null)
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.FeatureFlagAssignment", b =>
                {
                    b.HasOne("KromicStore.Domain.Tenants.FeatureFlag", null)
            ...
            modelBuilder.Entity("KromicStore.Domain.Tenants.ThemeAsset", b =>
                {
                    b.HasOne("KromicStore.Domain.Tenants.Theme", null)
                        .WithMany()
